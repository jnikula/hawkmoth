...
latex_documents = [
    (master_doc, 'HawkmothTest.tex', 'Hawkmoth Test Documentation',
     'Jani Nikula', 'manual'),
]
...
man_pages = [
    (master_doc, 'hawkmothtest', 'Hawkmoth Test Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HawkmothTest', 'Hawkmoth Test Documentation',
     author, 'HawkmothTest', 'One line description of project.',
     'Miscellaneous'),
]
