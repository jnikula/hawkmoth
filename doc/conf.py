# -*- coding: utf-8 -*-
#
# Hawkmoth documentation build configuration file, created by
# sphinx-quickstart on Mon Aug 14 22:32:19 2017.
#
...
project = u'Hawkmoth'
copyright = u'2017, Jani Nikula'
author = u'Jani Nikula'
...
latex_documents = [
    (master_doc, 'Hawkmoth.tex', u'Hawkmoth Documentation',
...
man_pages = [
    (master_doc, 'hawkmoth', u'Hawkmoth Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Hawkmoth', u'Hawkmoth Documentation',
     author, 'Hawkmoth', 'One line description of project.',
     'Miscellaneous'),
]
